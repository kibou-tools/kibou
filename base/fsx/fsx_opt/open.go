...
func Open(rw OpenRW) OpenOptionsBuilder {
	...
	return OpenOptionsBuilder{rw: rw, mode: OpenMode_Existing}
}
...
func (b OpenOptionsBuilder) Build() (OpenOptions, *OpenOptionsBuildError) {
	...
	if b.mode == OpenMode_CreateNew && b.truncate {
	...
	return OpenOptions{rw: b.rw, mode: b.mode, append: b.append, truncate: b.truncate}, nil
}
...
// NeededBy returns which setting needed the necessary permission.
...
func missingWritePerm(neededBy string) *OpenOptionsBuildError {
	return &OpenOptionsBuildError{
		kind:     OpenOptionsBuildErrorKind_MissingWritePermission,
		neededBy: neededBy,
	}
}
