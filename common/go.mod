module code.kibou.tools/common
...
// tools declared by any main module in go.work. We intentionally pin
// golangci-lint here and invoke it from repo root for both common/ and meta/.
