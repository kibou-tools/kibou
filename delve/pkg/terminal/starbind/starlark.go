...
//go:generate go run github.com/go-delve/build-tools/cmd/gen-starlark-bindings go ./starlark_mapping.go
//go:generate go run github.com/go-delve/build-tools/cmd/gen-starlark-bindings doc ../../../Documentation/cli/starlark.md
